...
1.Run the following command to set the user environment variable for email,password and subject to be searched:
setx key “value”
...
docker run -d -p 4545:4444 --name selenium-hub selenium/hub&nbsp;</strong> (Here 4545 is the port number you want to have to run the execution you can give value.
